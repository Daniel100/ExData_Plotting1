...
png(filename = "plot4.png", width = 480, height = 480)
  par(mfrow =c(2,2))
  # plot 2 ---
  DT = UCI_EPC[, .(AGAP = sum(Global_active_power)), by = DateTime]
  plot(DT$DateTime, DT$AGAP, type = "l", ylab = "Global Active Power", xlab="")
  
  # plot4 ---
  plot(UCI_EPC$DateTime, UCI_EPC$Voltage, type = "l", ylab = "Voltage", xlab="datetime")
  ...
  # plot 5 ---
  plot(UCI_EPC$DateTime, UCI_EPC$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab="datetime")
